...
function drawOnCanvas() {
	...
	draw_text(dictionary["goat"], big_text, textColor, 68/divisor, 97/divisor);
	if (player_number == 1) { textColor = "yellow" } else { textColor = "white" }
	draw_text(dictionary["sheep"], big_text, textColor, 226/divisor, 32/divisor);
	if (player_number == 2) { textColor = "yellow" } else { textColor = "white" }
	draw_text(dictionary["you"], big_text, textColor, 226/divisor, 547/divisor);
	textColor = "white";
