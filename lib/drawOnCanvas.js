function drawOnCanvas() {
	...
	if (gamePhase == 6) {
		...
		if (howManySetWinners == 1) {
			if (setWinner == 2) {
				draw_text(dictionary["most_points"][setWinner], small_text, "white", scoreTextX, 367/divisor);
				draw_text(dictionary["congrats"], small_text, "white", scoreTextX, 387/divisor);
			} else {
				draw_text(dictionary["most_points"][setWinner], small_text, "white", scoreTextX, 367/divisor);
				draw_text(dictionary["lost"], small_text, "white", scoreTextX, 387/divisor);
			}
		} else {
			draw_text(dictionary["tie"], small_text, "white", scoreTextX, 367/divisor);
			if (setLooser == 2) {
				draw_text(dictionary["lost"], small_text, "white", scoreTextX, 387/divisor);
			}
		}
