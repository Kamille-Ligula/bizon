...
function drawOnCanvas() {
	...
	for (i = 0; i < hands[0].length; i++) {
		draw_card(hands[0][i].draw_rank, hands[0][i].draw_suit, card_width, card_height, handX[0], handY[0]+i*40/divisor, true, true);
	}
	for (i = 0; i < hands[1].length; i++) {
		draw_card(hands[1][i].draw_rank, hands[1][i].draw_suit, card_width, card_height, handX[1]+i*40/divisor, handY[1], true, false);
	}
